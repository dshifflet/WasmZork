...
//                  Debug.WriteLine(dictEntry.str);
        ...
        public string[] Tokenize(string input, char splitOn)
        {
        ...
        {            
            ...
            //this won't compile under the Ooui WASM thing...
            //var wordArray = input.Split(' ');        // Tokenize into words
            var wordArray = Tokenize(input, ' ');
